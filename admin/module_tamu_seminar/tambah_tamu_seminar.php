<div class="modal fade" id="tambah_data" role="dialog">
  <div class="modal-dialog">
    ...
    <form class="form-horizontal" method="POST" action="module_tamu_seminar/action_tamu_seminar.php">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
              <label for="admin-name" class="col-lg-4 control-label">Kode Tamu: </label>
              <div class="col-lg-8">
