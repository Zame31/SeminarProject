...
// Nama Kolom Heading
$header = array('No', 'Kode lokasi', 'Nama Lokasi','Alamat','Kota','Harga Sewa','Fasilitas');

// Data loading
$query="select kode_lokasi,nama_lokasi,alamat,kota,harga_sewa,fasilitas from lokasi";
